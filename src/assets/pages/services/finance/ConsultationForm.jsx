...
function Evolution() {
    return (
        <div id='contactForm' className='px-5 md:px-10 mx-auto my-5 py-8 lg:py-10'>
            <div className='text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary capitalize text-center'>Book Appointment now</div>
            <form className='w-full sm:w-4/5 grid grid-cols-1 md:grid-cols-2 mt-10 gap-5 border border-gray-400 rounded-2xl p-5 mx-auto'>

...
const Procedures = () => {
  ...
  return (
    <div id='features' className='w-[95vw] container flex justify-center mx-auto my-5 py-8 lg:py-10'>
      <div className="h-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl border border-secondary py-8 transition-transform duration-300 hover:scale-105">

        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 px-5">
          ...
          <div className="md:w-1/2 mt-5 sm:mt-16 md:mt-0">
            ...
            <div className="space-y-4 text-primary">
              ...
              <Link to="/about">
                <button className="text-lg font-semibold mt-4 border border-secondary hover:bg-secondary cursor-pointer text-black px-8 py-3 rounded-lg transition duration-300 transform hover:scale-105 ">
                  Know More
                </button>
              </Link>
            </div>

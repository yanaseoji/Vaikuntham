    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="max-w-sm rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-xl bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 p-6 flex flex-col items-center">
        <div className="text-center text-white">
          ...
          <button className="mt-auto bg-white text-pink-600 font-semibold py-2 px-6 rounded-full hover:bg-pink-100 transition-all duration-300">
      ...
      <div className="max-w-sm rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-xl bg-gradient-to-r from-teal-400 to-blue-500 p-6 flex flex-col items-center">
        <div className="text-center text-white">
          ...
          <Link to="/Labroatry">
            <button className="mt-auto bg-white text-teal-600 font-semibold py-2 px-6 rounded-full hover:bg-teal-100 transition-all duration-300">
              Explore Lab
            </button>
          </Link>
        </div>
      ...
      <div className="max-w-sm rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-xl bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 p-6 flex flex-col items-center">
        <div className="text-center text-white">
          ...
          <Link to="/Products">
            <button className="mt-auto bg-white text-purple-600 font-semibold py-2 px-6 rounded-full hover:bg-purple-100 transition-all duration-300">
              View Products
            </button>
          </Link>
        </div>
